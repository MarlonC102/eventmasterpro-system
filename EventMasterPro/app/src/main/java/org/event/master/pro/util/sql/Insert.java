...
public enum Insert {
    ...
    INSERT_INVITED("INSERT INTO event_invited_artist (event_id, artist_id) VALUES (?, ?)"),
    ...
    INSERT_EVENT("INSERT INTO event (name, description, date_event, location_id, duration, sponsor, type, classification, participants_number, principal_artist_id, person_id) VALUES (?,?,?,?,?,?,?,?,?,?,?)"),
