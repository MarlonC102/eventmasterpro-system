...
import org.event.master.pro.finance.FinanceUI;
...
public class ListEventPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        eventTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Date", "Status", "Quorum", "Type", "See", "Edit", "Publish", "ID", "Finance", "Buy Ticket"
            }
        ) {
        ...
        statusCombobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Created", "Published", "Progress", "Finished", "Cancelled" }));
    ...
    private void tableEvent(String status) {
        ...
        DefaultTableModel modelTableEvent = (DefaultTableModel) eventTable.getModel();
        for (Event e : events) {
            modelTableEvent.addRow(new Object[]{e.getName(), e.getDateTimeEvent(), e.getStatusEvent(), e.getParticipantsNumbers(), e.getType(), "See", "Edit", "Publish Event", e.getIdEvent(), "Assign Finance","Buy Ticket"});
        }
        if (account.getRol().equals("customer")) {
            
        }
        UIUtil.hideButtons(account.getRol(), eventTable);
        buttonsEvent();
    }
    ...
    private void buttonsEvent() {
        eventTable.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                try {
                    FinanceUI.buttonFunctional(container, evt, eventTable, fdao);
